<?php
/**
 * SAIFGS_Singleton trait which implements SAIFGS_Singleton pattern in any class in which this trait is used.
 *
 * Using the SAIFGS_singleton pattern in WordPress is an easy way to protect against
 ...
 * this trait. SAIFGS_Singletons are a way to safely use globals; they let you
...
if ( ! trait_exists( '\SAIFGS\Traits\SAIFGS_Singleton' ) ) {
	trait SAIFGS_Singleton {
		/**
